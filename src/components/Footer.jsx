  ...
  return (
    <section>
      <div className='flex  justify-between gap-[20px] pb-[100px] w-full max-w-[1450px] mx-auto px-4 lg:px-[20px]  pt-[100px]'>
        ...
        <ul>
          <h3 className='text-[1.5em] font-bold my-5'>{t("menyu")}</h3>
        ...
        <ul className='cursor-pointer'>
          <h3 className='text-[1.5em] font-bold my-5'>{t("Contacts")}</h3>
          <li className='mb-[10px] text-[14px] text-[#4e4e4e]'>{t("location")}</li>
          <li className='mb-[10px] text-[14px] text-[#4e4e4e]'>{t("con-email")}</li>
          <li className='mb-[10px] text-[14px] text-[#4e4e4e]'>{t("con-tg")}</li>
        ...
        <div className='w-[35%]'>
          ...
          <form onSubmit={handleSubmit} className='flex justify-between border p-2 pl-4 rounded-[20px] border-[#555353]'>
            ...
            <button className='bg-[red] p-[15px] text-white text-[14px] font-[400] hover:bg-[black] cursor-pointer transition-all duration-200 rounded-[20px]'>{t("f-submit")}</button>
          </form>
