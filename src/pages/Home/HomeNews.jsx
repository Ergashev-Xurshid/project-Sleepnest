...
function HomeNews() {
  ...
  return (
    <div>
      ...
      <ul className='grid grid-cols-1 md:grid-cols-3 gap-[20px]'>
        {newsItems.map((item , idx )=> (
          <li key={idx} className='mb-[60px] md:mb-0'>
            <div className='rounded-[20px] w-full   md:w-[85%] h-auto overflow-hidden'>
            ...
            <h3 className='max-w-[450px] text-[1.17em] font-bold my-[10px] lg:my-[18px]'>{t(item.title)}</h3>
