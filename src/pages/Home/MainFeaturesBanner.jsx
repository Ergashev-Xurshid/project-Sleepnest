...
function MainFeaturesBanner({bannerIMG , style}) {
  ...
  return (
    <div className={`${style} pt-[200px] mt-[200px] features-banner-shadow xl:mt-[100px] relative text-white flex flex-wrap max-md:justify-center max-md:text-center items-center xl:justify-between rounded-[30px] p-[20px] lg:p-[100px] gap-[20px]`}>
      <div className=' xl:flex-2 '>
        <p className='font-[800] text-[50px]  xl:text-[90px] mb-5'>100%</p>
        <p className='text-[20px]'>{t("hero-baner-text")}</p>
      </div>
      <div className='w-full xl:w-[800px]  h-auto absolute left-0 md:left-[20] top-[-100px] md:top-[-425px]  xl:top-[-80px]  xl:left-[20%] '>
