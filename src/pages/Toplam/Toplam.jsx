      ...
      <div className='flex flex-col md:flex-row'>
        <div className="w-full md:w-1/3  lg:w-1/4 p-4">
          <form className='flex justify-between border p-2 pl-4 rounded-[20px] border-[#555353]'>
            ...
            <a className='xl:inline-block hidden  bg-[red] p-[15px] text-white text-[14px] font-[400] hover:bg-[black] cursor-pointer transition-all duration-200 rounded-full'><FaSearch /></a>
          </form>
